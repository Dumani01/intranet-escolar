...
- `src/components/AnnouncementsModule.tsx`
- `src/components/AcademicModule.tsx`
- `src/components/AttendanceChart.tsx`

Esta parte contiene 1414 líneas de código. Copie solamente la carpeta `src` sobre un clon de `00-base-main` y acepte reemplazar los archivos.
