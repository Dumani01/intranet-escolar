...
| --- | --- | --- |
| `feature/jared-academico-comunicados` | Jared | Navbar, Sidebar, comunicados, académico y gráfico de asistencia |
| `feature/companero-usuarios-ia` | Compañero | Autenticación, gestión de usuarios, perfil y asistente de IA |
